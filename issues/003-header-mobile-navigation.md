...
- [ ] On viewports < 768px, the "Contact Me" link in the header is hidden
- [ ] On viewports < 768px, the MenuButton (hamburger) is visible in the header in the same position
- [ ] Tapping the MenuButton opens the NavOverlay (via MenuContext — existing mechanism)
- [ ] The NavOverlay contains four links: Home, Projects, Blog, Contact
- [ ] Contact link in the overlay points to `/#contact` so it works from any route
- [ ] On viewports >= 768px, the header is visually unchanged
