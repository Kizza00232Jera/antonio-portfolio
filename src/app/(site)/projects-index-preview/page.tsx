...
import { IndexListPreview } from '@/components/preview/IndexListPreview'

export const metadata: Metadata = {
  title: 'Projects (Index Preview) | Antonio',
  robots: { index: false, follow: false },
}

export default async function ProjectsIndexPreviewPage() {
      ...
      <main className="mx-auto max-w-[1400px] px-5 pb-24 pt-28 md:px-10 md:pt-36">
        <header className="mb-10 md:mb-14">
          ...
          <p className="mt-6 text-[0.7rem] uppercase tracking-widest text-text-muted">
            Index preview (Direction A), not your live page. Hover the names.
          </p>
        </header>

        <IndexListPreview projects={projects} />
      </main>
    </div>
  )
}
